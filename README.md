...
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=ts,js,go,powershell,swift,java,py,bash,spring,vite,react,nextjs,angular,tailwind,nodejs,vscode,visualstudio,ae,idea,androidstudio,blender,github,git,discord,bots,docker,electron,express,prisma,mongodb,mysql,firebase,postman&perline=8" />
  </a>
</p>
