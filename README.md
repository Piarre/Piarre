...
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=ts,js,go,powershell,swift,java,py,bash,spring,vite,react,nextjs,tailwind,nodejs,vscode,visualstudio,idea,androidstudio,blender,github,git,docker,electron,express,linux,prisma,mongodb,mysql,firebase,postman&perline=8" />
  </a>
</p>
